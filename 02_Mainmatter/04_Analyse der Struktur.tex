...
\subsection{Laterale Beschleunigung}
  ...
  \begin{figure}[!ht]
    \centering
      ...
      \begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[width=0.35\linewidth]{04_figures/1.4 Träger.png}
        \caption{Schematische darstellung der idealisierung eines Profiles der Träger.}
        \label{1.4 Träger}
      \end{subfigure}%
...
\begin{center}
  \includegraphics[width=0.8\textwidth]{04_Figures/1.5 Idealisierung.png}
